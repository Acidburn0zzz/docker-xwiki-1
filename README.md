# XWiki [v9.3.1] Standalone – Docker Image

**[The Advanced Open Source Enterprise Wiki](http://www.xwiki.org/xwiki/bin/view/Main/WebHome)**

[![Latestver](https://lv.binarybabel.org/catalog-api/xwiki/stable.svg?v=9.3.1)](https://github.com/binarybabel/docker-xwiki/releases)
...
```
# docker run -p 8080:8080 -v $(pwd):/xwiki-data binarybabel/xwiki:v9.3.1
```
...
services:
  app:
    image: binarybabel/xwiki:v9.3.1
    volumes:
      - .:/xwiki-data
    ports:
      - "8080:8080"
