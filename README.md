# XWiki [v10.4] Standalone – Docker Image

**[The Advanced Open Source Enterprise Wiki](http://www.xwiki.org/xwiki/bin/view/Main/WebHome)**

[![Latestver](https://lv.binarybabel.org/catalog-api/xwiki/stable.svg?v=10.4)](https://github.com/binarybabel/docker-xwiki/releases)
...
```
# docker run -p 8080:8080 -v $(pwd):/xwiki-data binarybabel/xwiki:v10.4
```
